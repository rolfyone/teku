...
package tech.pegasys.teku.spec.logic.versions.eip8198.forktransition;
...
public class Eip8198StateUpgrade implements StateUpgrade<BeaconStateGloas> {

  private final SpecConfigEip8198 specConfig;
  private final SchemaDefinitionsHeze schemaDefinitions;
  private final BeaconStateAccessorsGloas beaconStateAccessors;

  public Eip8198StateUpgrade(
            ...
            state -> {
              ...
              state.setFork(
                  new Fork(
                      ...
                      specConfig.getEip8198ForkVersion(),
                      epoch));
